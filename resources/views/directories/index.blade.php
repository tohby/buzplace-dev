    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-{{ Auth::user()->is_admin == true ? 4 : 6 }}">
                <form class="form-group d-inline form-group-lg" action="{{ action('DirectoriesController@search') }}"
                    method="POST">
                    @csrf
                    ...
                    @foreach ($directories as $directory)
                        <div class="col-lg-3">
                            <div class="card border-0 transparent">
                                <img src="/storage/directories/{{ $directory->image }}"
                                    class="card-img-top news-img rounded-lg" alt="...">
                                <div class="card-body">
